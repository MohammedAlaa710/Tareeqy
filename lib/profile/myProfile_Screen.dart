  ...
  Future<void> _fetchTickets(List<String> ticketIds) async {
    ...
    for (String ticketId in ticketIds) {
      ...
      if (ticketDoc.exists) {
        ...
        ticketData['id'] = ticketId;  // Include the document ID in the ticket data
        if (!ticketData['out']) {
            ...
            child: _tickets.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        color: ticket['in'] ? Colors.lightGreen : null,
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              if (ticket['in']) Text('This ticket is in use', style: TextStyle(color: Colors.white)),
                            ],
                          ),
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => QRcode(qrData: ticket['id']),
                              ),
                            );
                          },
                        ),
